...
public class BenevolentAncestor extends AbstractCard {
    ...
    private class BenevolentAncestorCreature extends AbstractCreature {
        ...
        private class ProtectionEffect extends AbstractEffect implements TargetingEffect {
            ...
            public void resolve() { 
                if (target==null) {
                    //CardGame.instance.getModel().sendToModel(cardName + ": damage prevention effect has no target");
                    return;    
                }
                ...
                target.accept( new GameEntityVisitor() {
                    ...
                    public void visit(Player p) {
                        ...
                        CardGame.instance.getTriggers().register(Triggers.END_FILTER, 
                                new TriggerAction() {
                                    public void execute() {
                                        //CardGame.instance.getModel().sendToModel("Removing " + cardName + ": damage prevention effect");
                    ...
                    public void visit(DecoratedCreature c) {
                        ...
                        if (ctarget.isRemoved()) {
                            //CardGame.instance.getModel().sendToModel(cardName + ": damage prevention effect targets a removed creature");
                            return;
                        }
    ...
    private class BenevolentAncestorDamageStrategy extends AbstractDamageStrategyDecorator {
        ...
        public void inflictDamage(int dmg) {
            //CardGame.instance.getModel().sendToModel(cardName + " preventing 1 damage to player");
    ...
    public String getBackground() {
        return "image/Benevolent_Ancestor.jpg";
    }
