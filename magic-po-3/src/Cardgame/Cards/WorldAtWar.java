...
public class WorldAtWar extends AbstractCard {
    ...
    private class TurnChange extends AbstractPhaseManager {
        ...
        public Phases currentPhase() { 
            ...
            switch (phaseidx) {
                ...
                default: //should not happen!
                    //CardGame.instance.getModel().sendToModel( cardName + " turn beyond range. Odd! Removing it");
        ...
        public Phases nextPhase() {
            ++phaseidx;
            if (phaseidx>2) {
                //CardGame.instance.getModel().sendToModel("Removing " + cardName + " turn changes");
                CardGame.instance.getCurrentPlayer().removePhaseManager(this);
                notifyObservers();
            ...
            if (phaseidx==1) {
                ...
                //CardGame.instance.getModel().sendToModel( cardName + " untapping creatures before new combat phase");
